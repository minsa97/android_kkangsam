...
import com.mctlhg.kkangsam.databinding.ActivityBatteryInfoTestBinding

class BatteryInfo_Test : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //setContentView(R.layout.activity_battery_info_test)

        val binding = ActivityBatteryInfoTestBinding.inflate(layoutInflater)
        ...
        binding.button.setOnClickListener {
            val intent = Intent(this, MyBatteryReceiver::class.java)
